...
type InputPropsItem = Pick<React.HTMLProps<Element>, 'onBlur' | 'onInput' | 'onChange' | 'onKeyDown' | 'onMouseDown'>;
...
export default function Input({
  ...
  const createEventHandler = <E extends React.SyntheticEvent>(
  ...
  return (
    ...
    >
                ...
                <div className="input__picture">
                  ...
                  <label htmlFor={`${name}-picture`} className="input__picture--label">
                    ...
                    <input
                        ...
                        onChange={createEventHandler(setIsInputMouseFocused, handleFileChange)}
                    />
                  </label>
                </div>
            )
      ...
      {currentIsInvalid && <Feedback id={`${componentId}-feedback`} context="error">{invalidMessage ?? ''}</Feedback>}
