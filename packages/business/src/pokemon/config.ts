import {
    ...
    EnsureImageParams, EnsureRelationsParams, EnsureSpecieParams,
...
export function ensureAttributes(params: EnsureAttributesParams): Omit<EnsureAttributesParams, 'stats'> {
  if (params?.stats) {
...
function convertStatsToAttributes(stats: PokemonByNameResponse['stats']): Omit<EnsureAttributesParams, 'stats'> {
    return stats.reduce(
        (acc, stat) => {
...
export function ensureRelations(params: EnsureRelationsParams): Omit<EnsureRelationsParams, 'pokemonByName'> {
...
export function ensureSpecie(params: EnsureSpecieParams): Omit<EnsureSpecieParams, 'specieByPokemonName'> {
