...
describe('BankService', () => {
    ...
    describe('create', () => {
        it('should successfully create an bank', async () => {
            mockNest.finance.bank.create.mockResolvedValue(
                mockEntity,
            );
    ...
    describe('update', () => {
        it('should successfully update an bank', async () => {
            mockNest.finance.bank.update.mockResolvedValue(
                mockEntity,
            );
        ...
        it('should throw an error if the update fails', async () => {
            ...
            mockNest.finance.bank.update.mockRejectedValue(
                mockError,
            );
    ...
    describe('delete', () => {
        it('should successfully delete an bank', async () => {
            ...
            mockNest.finance.bank.delete.mockResolvedValue(
                mockResponse,
            );
            const result = await service.remove(mockEntity.id);

            expect(
                mockNest.finance.bank.delete,
            ).toHaveBeenCalledWith(mockEntity.id);
    ...
    describe('get', () => {
        it('should successfully get an bank', async () => {
            mockNest.finance.bank.getOne.mockResolvedValue(
                mockEntity,
            );
            const result = await service.get(mockEntity.id);

            expect(
                mockNest.finance.bank.getOne,
            ).toHaveBeenCalledWith(mockEntity.id);
            expect(result).toEqual(mockEntity);
        });
    });
    ...
    describe('getAll', () => {
        it('should successfully getAll bank list', async () => {
            mockNest.finance.bank.getAll.mockResolvedValue(
                mockEntityList,
            );
            const result = await service.getAll({});

            expect(
                mockNest.finance.bank.getAll,
            ).toHaveBeenCalledWith({});
