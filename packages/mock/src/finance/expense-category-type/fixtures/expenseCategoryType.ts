...
export const ACCOUNT_DEBIT_EXPENSE_CATEGORY_TYPE_FIXTURE: ExpenseCategoryType =
  new ExpenseCategoryType({
    ...
    name: 'Account Debit',
    created_at: new Date('2025-02-02T19:46:54.072Z'),
    updated_at: new Date('2025-02-02T19:46:54.072Z'),
    deleted_at: null,
  });
...
export const BANK_SLIP_EXPENSE_CATEGORY_TYPE_FIXTURE: ExpenseCategoryType =
  new ExpenseCategoryType({
    ...
    name: 'Bank Slip',
    created_at: new Date('2025-02-03T19:46:54.072Z'),
    updated_at: new Date('2025-02-03T19:46:54.072Z'),
    deleted_at: null,
  });
...
export const PIX_EXPENSE_CATEGORY_TYPE_FIXTURE: ExpenseCategoryType =
  new ExpenseCategoryType({
    ...
    name: 'PIX',
    created_at: new Date('2025-02-04T19:46:54.073Z'),
    updated_at: new Date('2025-02-04T19:46:54.073Z'),
    deleted_at: null,
  });
