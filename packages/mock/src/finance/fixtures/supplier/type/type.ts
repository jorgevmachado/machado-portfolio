...
export const BILLS_SUPPLIER_TYPE_FIXTURE: SupplierType = new SupplierType({ name: 'Bills' });
export const UNKNOWN_SUPPLIER_TYPE_FIXTURE: SupplierType = new SupplierType({ name: 'Unknown' });
