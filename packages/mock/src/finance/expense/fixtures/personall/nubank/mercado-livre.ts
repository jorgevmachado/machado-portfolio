...
import {MELIMAIS_MERCADO_LIVRE_SUPPLIER_FIXTURE, MERCADO_LIVRE_SUPPLIER_FIXTURE} from '../../../../supplier';
import { MERCADO_LIVRE_CREDIT_CARD_EXPENSE_CATEGORY_FIXTURE } from '../../../../expense-category';
...
export const MELIMAIS_MERCADO_LIVRE_PERSONAL_FIXTURE: Expense = new Expense({
  ...
  category: MERCADO_LIVRE_CREDIT_CARD_EXPENSE_CATEGORY_FIXTURE,
  january: 27.99,
  february: 27.99,
  march: 27.99,
  april: 27.99,
