...
export const FOOD_SUPPLIER_TYPE_FIXTURE: SupplierType = new SupplierType({
  ...
  name: 'Food',
  created_at: new Date('2025-02-02T19:00:18.686Z'),
  updated_at: new Date('2025-02-02T19:00:18.686Z'),
  deleted_at: null,
});
export const TRANSPORT_SUPPLIER_TYPE_FIXTURE: SupplierType = new SupplierType({
  id: '5e9f3895-4b9f-473b-b100-43a51d25d4cc',
  name: 'Transport',
  created_at: new Date('2025-02-03T19:00:18.686Z'),
  updated_at: new Date('2025-02-03T19:00:18.686Z'),
  deleted_at: null,
});
...
export const LEISURE_SUPPLIER_TYPE_FIXTURE: SupplierType = new SupplierType({
  ...
  name: 'Leisure',
  created_at: new Date('2025-02-05T19:00:18.686Z'),
  updated_at: new Date('2025-02-05T19:00:18.686Z'),
  deleted_at: null,
});
export const EDUCATION_SUPPLIER_TYPE_FIXTURE: SupplierType = new SupplierType({
  id: '693a8c6a-0832-4acc-9a00-2f38ac2cab7b',
  name: 'Education',
  created_at: new Date('2025-02-06T19:00:18.688Z'),
  updated_at: new Date('2025-02-06T19:00:18.688Z'),
  deleted_at: null,
});
export const BILLS_SUPPLIER_TYPE_FIXTURE: SupplierType = new SupplierType({
  id: 'afdb7bc2-78ad-459c-9d1f-27b99e38f954',
  name: 'Bills',
  created_at: new Date('2025-02-07T19:00:18.688Z'),
  updated_at: new Date('2025-02-07T19:00:18.688Z'),
  deleted_at: null,
});
export const UNKNOWN_SUPPLIER_TYPE_FIXTURE: SupplierType = new SupplierType({
  id: '10f85833-96e5-44c6-a73a-9f4960ba9279',
  name: 'Unknown',
  created_at: new Date('2025-02-08T19:00:18.687Z'),
  updated_at: new Date('2025-02-08T19:00:18.687Z'),
  deleted_at: null,
});
