...
export const INGRID_RESIDENTIAL_EXPENSE_GROUP_FIXTURE: ExpenseGroup =
  new ExpenseGroup({
    ...
    created_at: new Date('2025-02-01T19:46:54.067Z'),
    updated_at: new Date('2025-02-01T19:46:54.067Z'),
    deleted_at: null,
  });
...
export const MONTE_CARLO_RESIDENTIAL_EXPENSE_GROUP_FIXTURE: ExpenseGroup =
  new ExpenseGroup({
    ...
    created_at: new Date('2025-02-02T19:46:54.068Z'),
    updated_at: new Date('2025-02-02T19:46:54.068Z'),
    deleted_at: null,
  });
...
export const MOTHER_EXPENSE_GROUP_FIXTURE: ExpenseGroup = new ExpenseGroup({
  ...
  name: 'Mother',
  created_at: new Date('2025-02-03T19:46:54.069Z'),
  updated_at: new Date('2025-02-03T19:46:54.069Z'),
  deleted_at: null,
});
